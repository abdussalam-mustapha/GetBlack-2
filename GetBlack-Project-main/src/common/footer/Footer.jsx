...
import logo from "../../components/assets/images/getblack-logo.png";
import googlePlayIcon from "../../components/assets/images/gogle.png";
import appStoreIcon from "../../components/assets/images/applestore.png";
import paymentIcon from "../../components/assets/images/payment.png";
    ...
    <>
     <footer className="footer p-10 bg-[#18191a] text-base-content">
        <div className="w-32 h-24 mb-10">
          ...
          <img src={paymentIcon} alt="" className="payIcon"/>
        </div>
        <div>
